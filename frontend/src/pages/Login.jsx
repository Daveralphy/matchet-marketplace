...
const features = [
  {
    ...
    icon: (
      <path
        ...
        d="M3 7h18l-1.5 12.5A2 2 0 0 1 17.5 21h-11a2 2 0 0 1-2-1.5L3 7Z M8 7V5a4 4 0 0 1 8 0v2"
      />
    ),
  },
  {
    label: "Trusted Providers",
    caption: "Verified & Reliable",
    bg: "bg-blue-100",
    fg: "text-blue-600",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 3l7 3v5c0 4.5-3 8.5-7 10-4-1.5-7-5.5-7-10V6l7-3Z M9.5 12l1.8 1.8L14.5 10"
      />
    ),
  },
  {
    label: "Local & Convenient",
    ...
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M17 20v-1a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v1 M10 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z M20 20v-1a3.5 3.5 0 0 0-2.5-3.4 M15.5 4.6A3 3 0 0 1 17 10.2"
      />
    ),
  },
];
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      <div className="hidden lg:flex lg:w-1/2 flex-col overflow-hidden bg-gray-50">
          ...
          <div className="flex flex-1 flex-col items-center justify-center">
            <div className="max-w-md">
              ...
              <p className="mt-4 text-gray-500">
                Shop products and book services from trusted providers around
                you. Simple, secure, and reliable.
              </p>
            </div>
            ...
            <div className="mt-10 flex max-w-md gap-6">
              {features.map((feature) => (
                <div key={feature.label} className="flex flex-col items-start">
                  <div
                    className={`flex h-16 w-16 items-center justify-center rounded-full ${feature.bg} ${feature.fg}`}
                  >
                    <svg
                      className="h-7 w-7"
                      fill="none"
                  ...
                  <p className="text-xs text-gray-500">{feature.caption}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="relative flex h-2/5 shrink-0 items-center justify-center border border-dashed border-gray-300 bg-gray-200 text-sm text-gray-400">
          [ Image placeholder ]
